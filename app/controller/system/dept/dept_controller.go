...
import (
	...
	deptService "rygo/app/service/system/dept"
...
func TreeData(c *gin.Context) {
	...
	result, _ := deptService.SelectDeptTree(0, "", "", tenantId)
...
func RoleDeptTreeData(c *gin.Context) {
	...
	result, err := deptService.RoleDeptTreeData(roleId, tenantId)
