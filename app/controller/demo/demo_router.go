...
import (
	"fmt"
	"rygo/app/controller/demo/form"
	"rygo/app/controller/demo/icon"
	"rygo/app/controller/demo/modal"
	"rygo/app/controller/demo/operate"
	"rygo/app/controller/demo/report"
	"rygo/app/controller/demo/table"
