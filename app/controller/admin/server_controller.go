...
import (
	...
	"rygo/app/response"
	ip2 "rygo/app/utils/ip"
	time2 "rygo/app/utils/time"
	"strconv"
	"time"
...
func (c *ServerController) Server(ctx *gin.Context) {
	...
	response.BuildTpl(ctx, "monitor/server/server").WriteTpl(gin.H{
		"cpuNum":          cpuNum,
		"cpuUsed":         cpuUsed,
		"cpuAvg5":         cpuAvg5,
		"cpuAvg15":        cpuAvg15,
