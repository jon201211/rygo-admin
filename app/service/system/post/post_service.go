...
import (
	...
	postModel "rygo/app/model/system/post"
...
//根据主键查询数据
func SelectRecordById(id int64) (*postModel.SysPost, error) {
	entity := &postModel.SysPost{PostId: id}
...
func DeleteRecordById(id int64) bool {
	rs, err := (&postModel.SysPost{PostId: id}).Delete()
	if err == nil {
		if rs > 0 {
			return true
		}
...
func EditSave(req *postModel.EditReq, c *gin.Context) (int64, error) {
	entity := &postModel.SysPost{PostId: req.PostId}
...
//根据条件分页查询角色数据
func SelectListByPage(params *postModel.SelectPageReq) ([]postModel.SysPost, *page.Paging, error) {
